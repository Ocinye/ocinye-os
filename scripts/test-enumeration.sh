...
# estrangulada a janela é observável em qualquer máquina, e o helper defeituoso
# falha à terceira volta.
#
...
#
# 90 desde 2026-09-09: entrou a prova de que uma hora local inexistente — a que o
# relógio salta na mudança para o horário de Verão — é recusada com a frase à
# vista na criação de um evento, e a hora válida adjacente cria.
#
...
viagens-de-browser|103|-p ocinye-workspace --test browser|VIAGEM LEVANTADA|103
...
# 14 → 21 em 2026-09-10: a fatia D partilha uma nota por pessoa — leitura ou
# edição —, e a autoridade de escrita reestabelece-se a cada gravação: um leitor
