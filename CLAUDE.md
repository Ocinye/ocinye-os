...
- **Ocinye Core: `IMPLEMENTED` e em produção.** 186 caminhos e 223 operações
...
- **Ocinye Workspace: `IMPLEMENTED` e em produção** 82 ecrãs em Leptos SSR,
...
- **1603 funções de teste** escritas na árvore, e **zero falhas** na última
  ...
  **593 dessas funções não correm sem base de dados** — vivem em ficheiros que leem
