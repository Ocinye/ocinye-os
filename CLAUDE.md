...
- **Ocinye Workspace: `IMPLEMENTED` e em produção** 86 ecrãs em Leptos SSR,
...
- **1642 funções de teste** escritas na árvore, e **zero falhas** na última
  ...
  **608 dessas funções não correm sem base de dados** — vivem em ficheiros que leem
