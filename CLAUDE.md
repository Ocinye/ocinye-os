...
- **Ocinye Core: `IMPLEMENTED` e em produção.** 193 caminhos e 230 operações
...
- **45 migrations**, aplicáveis de base vazia; 82 tabelas.
...
- **1611 funções de teste** escritas na árvore, e **zero falhas** na última
