...
- **Ocinye Core: `IMPLEMENTED` e em produção.** 177 caminhos e 209 operações
...
- **1521 funções de teste** escritas na árvore, e **zero falhas** na última
  ...
  **549 dessas funções não correm sem base de dados** — vivem em ficheiros que leem
