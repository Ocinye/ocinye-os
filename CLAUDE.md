...
- **Ocinye Core: `IMPLEMENTED` e em produção.** 190 caminhos e 228 operações
...
- **1607 funções de teste** escritas na árvore, e **zero falhas** na última
  ...
  **595 dessas funções não correm sem base de dados** — vivem em ficheiros que leem
