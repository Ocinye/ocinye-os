...
- **48 migrations**, aplicáveis de base vazia; 84 tabelas.
...
- **1629 funções de teste** escritas na árvore, e **zero falhas** na última
  ...
  **599 dessas funções não correm sem base de dados** — vivem em ficheiros que leem
