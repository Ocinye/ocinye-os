...
pub use service::{
    ...
    notes_shared_with_me, personal_note_revision_content, personal_note_revisions,
    purge_personal_note, record_operation_provenance, restore_personal_note,
    restore_personal_note_revision, review_bibliography, revoke_personal_note_share,
    share_personal_note, update_note, update_personal_note, NewDocument, NewNote, NewSource,
    NoteAccess, PersonalNoteEdit, UploadedFile,
};
