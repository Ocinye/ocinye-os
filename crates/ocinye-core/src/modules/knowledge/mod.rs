...
pub use service::{
    ...
    list_sources, member_can_view_note_file, move_personal_note, notes_shared_with_me,
    personal_note_revision_content, personal_note_revisions, purge_personal_note,
    record_operation_provenance, restore_personal_note, restore_personal_note_revision,
