...
[ADR-0001](../adrs/0001-ocinye-os-definition.md), e a que a alarga de uma
instituição a qualquer pessoa ou organização em
[ADR-0013](../adrs/0013-general-purpose-os-instance-and-node.md); esta secção é a
formulação corrente do que as duas produziram.
...
recursos ([ADR-0013](../adrs/0013-general-purpose-os-instance-and-node.md)).
